...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>View and manage appointment details effectively.</p>
        </div>

        <!-- Manage Appointments Section -->
        <div class="card card-custom">
            <div class="card-title">
                <h5><i class="fas fa-calendar-check"></i> Appointment List</h5>
            </div>
                ...
                <table class="table table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Scheduled</td>
                            <td><a href="editAppointment.jsp?id=101" class="btn btn-custom">Edit</a></td>
                        </tr>
                        <tr>
                            <td>102</td>
                            <td>Jane Doe</td>
                            <td>Dr. Jones</td>
                            <td>2024-12-12 11:00 AM</td>
                            <td>Scheduled</td>
                            <td><a href="editAppointment.jsp?id=102" class="btn btn-custom">Edit</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
