...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>View and manage doctor details effectively.</p>
        </div>

        <!-- Manage Doctors Section -->
        <div class="card card-custom">
            <div class="card-title">
                <h5><i class="fas fa-user-md"></i> Doctor List</h5>
            </div>

            <div class="card-body">
                <!-- Example Table for Doctors -->
                <table class="table table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>9876543210</td>
                            <td>Active</td>
                            <td><a href="editDoctor.jsp?id=1" class="btn btn-custom">Edit</a></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Dr. Jane Smith</td>
                            ...
                            <td>9876543211</td>
                            <td>Active</td>
                            <td><a href="editDoctor.jsp?id=2" class="btn btn-custom">Edit</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
